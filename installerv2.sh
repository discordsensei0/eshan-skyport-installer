...
main_menu() {
    while true; do
        ...
        echo -e "${ESHAN_GOLD}║${BWhite}              📋 ESHAN HUB                      ${ESHAN_GOLD}║${NC}"
        echo -e "${ESHAN_GOLD}╠════════════════════════════════════════════════════╣${NC}"
        echo -e "${ESHAN_GOLD}║${NC}                                                  ${ESHAN_GOLD}║${NC}"
        echo -e "${ESHAN_GOLD}║${NC}  ${BGreen}1${NC}) 🚀 ${BCyan}Skyport Panel${NC}                              ${ESHAN_GOLD}║${NC}"
        echo -e "${ESHAN_GOLD}║${NC}  ${BGreen}2${NC}) 🖥️  ${BCyan}Skyport Node${NC}       ${BGreen}[ACTIVE]${NC}              ${ESHAN_GOLD}║${NC}"
        echo -e "${ESHAN_GOLD}║${NC}  ${BGreen}3${NC}) 🐧 ${BCyan}Puffer Panel${NC}        ${BGreen}[BUILT-IN]${NC}             ${ESHAN_GOLD}║${NC}"
...
install_puffer_panel() {
    ...
    echo ""
    echo -e "${BGreen}╔════════════════════════════════════════════════════╗${NC}"
    echo -e "${BGreen}║         🐧 PUFFER PANEL INSTALLER 🐧              ║${NC}"
